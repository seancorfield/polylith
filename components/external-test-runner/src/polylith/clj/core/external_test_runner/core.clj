(ns polylith.clj.core.external-test-runner.core
...
(defn create
  ...
  (let [{:keys [bases components]} workspace
        ...
        my-runner-ns   "polylith.clj.core.external-test-runner-cli.main"
        colorizer-ns   "polylith.clj.core.util.interface.color"
